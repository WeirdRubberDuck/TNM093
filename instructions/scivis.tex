...
\begin{todolist}
  ...
  \item Interact with the camera controls and explain what the step size does and how volume rendering works and how you get a color for a pixel.  For this explanation you can assume that you already have an entry and an exit point, there is no need to explain anything prior to that.  Do this by drawing a sketch, preferably on a pece a paper. \textbf{Make sure you have done this sketch before presenting the lab} so that you can use it to explain how volume rendering works.
  ...
  \item Using the front-to-back compositing method, use your transfer function editor to interactively manipulate the transfer function to show the lab assisstant what is on the inside of the dataset. 
